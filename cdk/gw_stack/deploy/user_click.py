...
class UserClick(core.Stack):
    def __init__(self, scope: core.Construct, id: str,vpc: ec2.Vpc,
        ...
        image = "233121040379.dkr.ecr.cn-northwest-1.amazonaws.com.cn/user_click:latest"
        name = "user_click"
        env = {
            ...
            "AWS_PAIXU_URL":"http://conaws.com.cn:8080/invocations"
        }
