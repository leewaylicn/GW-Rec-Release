...
class Resultapi(core.Stack):
    def __init__(self, scope: core.Construct, id: str,vpc: ec2.Vpc,
        ...
        image = "233121040379.dkr.ecr.cn-northwest-1.amazonaws.com.cn/resultapi:latest"
        name = "resultapi"
        env = {
        ...
        self.url = GWEcsHelper.create_fagate_ALB_autoscaling(
            self,vpc,image,name,port=5500,ecs_role=GWAppHelper.create_ecs_role(self),env=env,public_load_balancer=True)