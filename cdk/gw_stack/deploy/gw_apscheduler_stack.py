...
class GWApschedulerStack(core.Stack):
    def __init__(self, scope: core.Construct, id: str,vpc: ec2.Vpc,
        ...
        image = "233121040379.dkr.ecr.cn-northwest-1.amazonaws.com.cn/apscheduler_task:latest"
        name = "apscheduler"
        env = {
            ...
            "AWS_PAIXU_URL":"http://b00/invocations"
        }
