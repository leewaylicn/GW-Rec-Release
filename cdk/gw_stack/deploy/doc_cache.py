...
class Doccache(core.Stack):
    def __init__(self, scope: core.Construct, id: str,vpc: ec2.Vpc,
        ...
        image = "233121040379.dkr.ecr.cn-northwest-1.amazonaws.com.cn/doc_cache:latest"
        name = "doc_cache"
        env = {
            ...
            "AWS_PAIXU_URL":"http://cdk-dd415f65b2d1.amazonaws.com.cn:9008/invocations",
            "AWS_VECTOR_URL":"http://cdkdffb614fdabeddzonaws.com.cn:9008/invocations"
        }
